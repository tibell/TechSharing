...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.trearisk.service.impl.PasswordTokenManager#generateRecoveryToken(com.trearisk.model.User)
     */
    @Override
    ...
    /**
     * @see com.trearisk.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.trearisk.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.trearisk.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
